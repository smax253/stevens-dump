...
(define (Euclid-list int1 int2)
  (if (zero? int2)
      '()
      (cons int1 (Euclid-list int2 (modulo int1 int2)))))
...
(define (wj-help fillA fillB maxA maxB goal)
  (cond
    ...
    ((zero? fillA) (cons (list fillA fillB) (wj-help maxA fillB maxA maxB goal)))
