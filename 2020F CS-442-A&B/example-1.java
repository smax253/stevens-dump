...
public class example {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //Q1
            System.out.println("Question 1 (Find the name of the drivers who got the license from the branch “NYC”.):");
            Statement s = conn.createStatement();
            ...
            //Q2
            System.out.println("Question 2 (Find the name of the drivers whose driver license expire by 12/31/2022.):");
            ...
            System.out.println("Question 3 (Find the name of the drivers who took at least 2 exams for the same driver license type at the same branch.):");
            s = conn.createStatement();
            ...
            //Q4
            System.out.println("Question 4 (Find the name of the drivers whose exam scores get consecutively lower when he/she took more exams.):");
            s = conn.createStatement();
